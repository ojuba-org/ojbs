#! /bin/bash
pushd $(dirname "$0")/..
base_arch=`[ $(arch) != 'x86_64' ] && echo "i386" || echo "x86_64"`
...
for $i (@a) {
  s:\Q<packagereq type="\E[^"]+\Q">\E${i}\Q</packagereq>\E:<packagereq type="optional">$i</packagereq>:;
}
...
s:\Q<packagereq type="\E[^"]+\Q">policycoreutils-gui</packagereq>\E:<packagereq type="optional">policycoreutils-gui</packagereq>:;
s:\Q<packagereq type="\E[^"]+\Q">selinux-policy-targeted</packagereq>\E:<packagereq type="optional">selinux-policy-targeted</packagereq>:;
s:\Q<packagereq type="\E[^"]+\Q">policycoreutils</packagereq>\E:<packagereq type="optional">policycoreutils</packagereq>:;
s:\Q<packagereq type="\E[^"]+\Q">setroubleshoot</packagereq>\E:<packagereq type="optional">setroubleshoot</packagereq>:;
s:\Q<packagereq type="\E[^"]+\Q">gnome-games</packagereq>\E:<packagereq type="optional">gnome-games</packagereq>:;
s:\Q<packagereq type="\E[^"]+\Q">gnome-games-help</packagereq>\E:<packagereq type="optional">gnome-games-help</packagereq>:;
s:\Q<packagereq type="\E[^"]+\Q">bind</packagereq>\E:<packagereq type="optional">bind</packagereq>:;
s:\Q<packagereq type="\E[^"]+\Q">audit</packagereq>\E:<packagereq type="optional">audit</packagereq>:;
s:\Q<packagereq type="\E[^"]+\Q">gcalctool</packagereq>\E:<packagereq type="optional">gcalctool</packagereq>:;

# make some optionals defaults
s:\Q<packagereq type="\E[^"]+\Q">p7zip</packagereq>\E:<packagereq type="default">p7zip</packagereq>:;
