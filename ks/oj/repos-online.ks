...
repo --name=released --overwrite_groups=0 --mirrorlist=http://mirrors.fedoraproject.org/mirrorlist?repo=fedora-16&arch=$basearch --exclude kernel*debug* --exclude kernel-kdump* --exclude syslog-ng --exclude java-1.5.0-gcj-devel --exclude generic* --exclude java-1.5.0-gcj-javadoc --exclude fedora-logos --exclude fedora-release --exclude fedora-release-notes

repo --name=updates --overwrite_groups=0 --mirrorlist=http://mirrors.fedoraproject.org/mirrorlist?repo=updates-released-f16&arch=$basearch --exclude kernel*debug* --exclude kernel-kdump* --exclude syslog-ng --exclude java-1.5.0-gcj-devel --exclude generic* --exclude java-1.5.0-gcj-javadoc  --exclude fedora-logos --exclude fedora-release --exclude fedora-release-notes
...
repo --name=adobe  --overwrite_groups=0 --baseurl=http://linuxdownload.adobe.com/linux/$basearch/ --exclude=AdobeReader*
